...
var createStyled = function createStyled2(tag, options) {
  ...
  return function() {
    ...
    Styled.withComponent = function(nextTag, nextOptions) {
      return createStyled2(nextTag, _extends3({}, options, nextOptions, {
...
var muiStyledFunctionResolver = ({
  ...
  const resolvedStyles = styledArg(_extends4({}, props, {
...
function prepareCssVars(theme, parserConfig) {
  ...
  const generateCssVars = (colorScheme) => {
    if (!colorScheme) {
      return {
        css: _extends4({}, rootCss),
        vars: rootVars
      };
    }
    return {
      css: _extends4({}, colorSchemesMap[colorScheme].css),
...
function createContainer(options = {}) {
  ...
  const Container2 = React26.forwardRef(function Container3(inProps, ref) {
    ...
    return (
      ...
      (0, import_jsx_runtime10.jsx)(ContainerRoot, _extends4({
        as: component,
        ownerState,
...
function createGrid(options = {}) {
  ...
  const Grid2 = React27.forwardRef(function Grid3(inProps, ref) {
    ...
    let result = (0, import_jsx_runtime11.jsx)(GridRoot, _extends4({
      ref,
      as: component,
      ownerState,
      className: clsx_default(classes.root, className)
...
function createStack(options = {}) {
  ...
  const Stack2 = React28.forwardRef(function Grid2(inProps, ref) {
    ...
    return (0, import_jsx_runtime12.jsx)(StackRoot, _extends4({
      as: component,
      ownerState,
      ref,
      className: clsx_default(classes.root, className)
...
function createTypography(palette2, typography2) {
  ...
  const buildVariant = (fontWeight2, size, lineHeight2, letterSpacing2, casing) => _extends6({
...
function createTransitions(inputTransitions) {
  const mergedEasing = _extends6({}, easing, inputTransitions.easing);
  const mergedDuration = _extends6({}, duration, inputTransitions.duration);
...
const theme2 = createTheme({ palette: {
  ...
  const paletteOutput = deepmerge(_extends6({
...
Please use another name.` : formatMuiErrorMessage(18));
  ...
  muiTheme.unstable_sxConfig = _extends6({}, defaultSxConfig_default, other == null ? void 0 : other.unstable_sxConfig);
  muiTheme.unstable_sx = function sx(props) {
    return styleFunctionSx_default({
      sx: props,
      theme: this
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-773VJR3H.js.map
