...
function appendOwnerState(elementType, otherProps, ownerState) {
  ...
  return _extends2({}, otherProps, {
    ownerState: _extends2({}, otherProps.ownerState, ownerState)
  });
}
...
function mergeSlotProps(parameters) {
  ...
  if (!getSlotProps) {
    ...
    const mergedStyle2 = _extends2({}, additionalProps == null ? void 0 : additionalProps.style, externalForwardedProps == null ? void 0 : externalForwardedProps.style, externalSlotProps == null ? void 0 : externalSlotProps.style);
    const props2 = _extends2({}, additionalProps, externalForwardedProps, externalSlotProps);
  ...
  const eventHandlers = extractEventHandlers(_extends2({}, externalForwardedProps, externalSlotProps));
  const componentsPropsWithoutEventHandlers = omitEventHandlers(externalSlotProps);
  const otherPropsWithoutEventHandlers = omitEventHandlers(externalForwardedProps);
  const internalSlotProps = getSlotProps(eventHandlers);
  const joinedClasses = clsx_default(internalSlotProps == null ? void 0 : internalSlotProps.className, additionalProps == null ? void 0 : additionalProps.className, className, externalForwardedProps == null ? void 0 : externalForwardedProps.className, externalSlotProps == null ? void 0 : externalSlotProps.className);
  const mergedStyle = _extends2({}, internalSlotProps == null ? void 0 : internalSlotProps.style, additionalProps == null ? void 0 : additionalProps.style, externalForwardedProps == null ? void 0 : externalForwardedProps.style, externalSlotProps == null ? void 0 : externalSlotProps.style);
  const props = _extends2({}, internalSlotProps, additionalProps, otherPropsWithoutEventHandlers, componentsPropsWithoutEventHandlers);
...
function useSlotProps(parameters) {
  ...
  } = parameters, rest = _objectWithoutPropertiesLoose2(parameters, _excluded);
  const resolvedComponentsProps = skipResolvingSlotProps ? {} : resolveComponentProps(externalSlotProps, ownerState);
  const {
    props: mergedProps,
    internalRef
  } = mergeSlotProps(_extends2({}, rest, {
    externalSlotProps: resolvedComponentsProps
  }));
  const ref = useForkRef(internalRef, resolvedComponentsProps == null ? void 0 : resolvedComponentsProps.ref, (_parameters$additiona = parameters.additionalProps) == null ? void 0 : _parameters$additiona.ref);
  const props = appendOwnerState(elementType, _extends2({}, mergedProps, {
    ref
  }), ownerState);
  return props;
}
...
var Badge = React3.forwardRef(function Badge2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime3.jsxs)(Root, _extends2({}, rootProps, {
    children: [children2, (0, import_jsx_runtime2.jsx)(BadgeComponent, _extends2({}, badgeProps, {
...
function useButton(parameters = {}) {
  ...
  const getRootProps = (externalProps = {}) => {
    const externalEventHandlers = _extends2({}, extractEventHandlers(parameters), extractEventHandlers(externalProps));
    const props = _extends2({
      type
...
var Button = React5.forwardRef(function Button2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime4.jsx)(Root, _extends2({}, rootProps, {
    children: children2
  }));
});
...
function getControlledState(internalState, controlledProps) {
  const augmentedState = _extends2({}, internalState);
...
var FormControl = React13.forwardRef(function FormControl2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime9.jsx)(FormControlContext.Provider, {
    value: childContext,
    children: (0, import_jsx_runtime9.jsx)(Root, _extends2({}, rootProps))
  });
});
...
function useInput(parameters = {}) {
  ...
  const getRootProps = (externalProps = {}) => {
    ...
    const externalEventHandlers = _extends2({}, propsEventHandlers, extractEventHandlers(externalProps));
    return _extends2({}, externalProps, externalEventHandlers, {
  ...
  const getInputProps = (externalProps = {}) => {
    ...
    const externalEventHandlers = _extends2({}, propsEventHandlers, extractEventHandlers(externalProps));
    const mergedEventHandlers = _extends2({}, externalEventHandlers, {
      onBlur: handleBlur2(externalEventHandlers),
      onChange: handleChange(externalEventHandlers),
      onFocus: handleFocus(externalEventHandlers)
    });
    return _extends2({}, mergedEventHandlers, {
...
var Input = React16.forwardRef(function Input2(props, forwardedRef) {
  ...
  const inputProps = useSlotProps({
    ...
    getSlotProps: (otherHandlers) => {
      return getInputProps(_extends2({}, propsToForward, otherHandlers));
    },
    externalSlotProps: slotProps.input,
    additionalProps: _extends2({
  ...
  return (0, import_jsx_runtime11.jsxs)(Root, _extends2({}, rootProps, {
    children: [startAdornment, (0, import_jsx_runtime10.jsx)(InputComponent, _extends2({}, inputProps)), endAdornment]
  }));
});
...
function useList(params) {
  ...
  const actionContext = React21.useMemo(() => _extends2({}, reducerActionContext, listActionContext), [reducerActionContext, listActionContext]);
  const [state, dispatch] = useControllableReducer({
    reducer,
    actionContext,
    initialState,
...
function combineHooksSlotProps(getFirstProps, getSecondProps) {
  return function getCombinedProps(external = {}) {
    const firstResult = _extends2({}, external, getFirstProps(external));
    const result = _extends2({}, firstResult, getSecondProps(firstResult));
    return result;
  };
}
...
function useMenu(parameters = {}) {
  ...
  const getListboxProps = (externalProps = {}) => {
    ...
    const externalEventHandlers = extractEventHandlers(externalProps);
    return _extends2({}, externalProps, externalEventHandlers, getCombinedRootProps(externalEventHandlers), {
      id: listboxId,
      role: "menu"
    });
  };
  ...
  return {
    contextValue: _extends2({}, compoundComponentContextValue, listContextValue),
    dispatch: listDispatch,
    getListboxProps,
    highlightedValue,
...
var Portal = React28.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React28.isValidElement(children2) ? children2.ref : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
...
var PopperTooltip = React29.forwardRef(function PopperTooltip2(props, forwardedRef) {
  ...
  useEnhancedEffect_default(() => {
    ...
    const popper2 = createPopper3(resolvedAnchorElement, tooltipRef.current, _extends2({
  ...
  return (0, import_jsx_runtime14.jsx)(Root, _extends2({}, rootProps, {
...
var Popper = React29.forwardRef(function Popper2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime14.jsx)(Portal, {
    disablePortal,
    container,
    children: (0, import_jsx_runtime14.jsx)(PopperTooltip, _extends2({
      anchorEl,
      direction,
      disablePortal,
      modifiers,
...
var Menu = React30.forwardRef(function Menu2(props, forwardedRef) {
  ...
  if (open === true && triggerElement == null) {
    return (0, import_jsx_runtime15.jsx)(Root, _extends2({}, rootProps, {
      children: (0, import_jsx_runtime15.jsx)(Listbox, _extends2({}, listboxProps, {
  ...
  return (0, import_jsx_runtime15.jsx)(Popper, _extends2({}, rootProps, {
    open,
...
var MenuButton = React32.forwardRef(function MenuButton2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime16.jsx)(Root, _extends2({}, rootProps, {
    children: children2
  }));
});
...
function useMenuItem(params) {
  ...
  const getOwnHandlers = (otherHandlers = {}) => _extends2({}, otherHandlers, {
    onClick: createHandleClick(otherHandlers)
  });
...
var MenuItem = React35.forwardRef(function MenuItem2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime17.jsx)(Root, _extends2({}, rootProps, {
    children: children2
  }));
});
...
var Modal = React37.forwardRef(function Modal2(props, forwardedRef) {
  ...
  const {
    ...
    exited,
    hasTransition
  } = useModal(_extends2({}, propsWithDefaults, {
    rootRef: forwardedRef
  }));
  ...
  return (0, import_jsx_runtime18.jsx)(Portal, {
    ...
    container,
    disablePortal,
    children: (0, import_jsx_runtime19.jsxs)(Root, _extends2({}, rootProps, {
      children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime18.jsx)(BackdropComponent, _extends2({}, backdropProps)) : null, (0, import_jsx_runtime18.jsx)(FocusTrap, {
        disableEnforceFocus,
        disableAutoFocus,
        disableRestoreFocus,
...
function useNumberInput(parameters) {
  ...
  const getInputProps = (externalProps = {}) => {
    var _ref;
    const externalEventHandlers = _extends2({
      onBlur,
      onFocus
    }, extractEventHandlers(externalProps, ["onInputChange"]));
    const mergedEventHandlers = _extends2({}, externalProps, externalEventHandlers, {
      onFocus: handleFocus(externalEventHandlers),
      onChange: handleInputChange(_extends2({}, externalEventHandlers, {
        onInputChange
      })),
      onBlur: handleBlur2(externalEventHandlers),
  ...
  const getIncrementButtonProps = (externalProps = {}) => {
    return _extends2({}, externalProps, stepperButtonCommonProps, {
...
var NumberInput = React40.forwardRef(function NumberInput2(props, forwardedRef) {
  ...
  const inputProps = useSlotProps({
    elementType: Input5,
    getSlotProps: (otherHandlers) => getInputProps(_extends2({}, otherHandlers, propsForwardedToInputSlot)),
    externalSlotProps: slotProps.input,
    ownerState,
    className: classes.input
  });
  ...
  return (0, import_jsx_runtime22.jsxs)(Root, _extends2({}, rootProps, {
    children: [(0, import_jsx_runtime21.jsx)(DecrementButton, _extends2({}, decrementButtonProps)), (0, import_jsx_runtime21.jsx)(IncrementButton, _extends2({}, incrementButtonProps)), startAdornment, (0, import_jsx_runtime21.jsx)(Input5, _extends2({}, inputProps)), endAdornment]
  }));
});
...
var OptionGroup = React41.forwardRef(function OptionGroup2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime24.jsxs)(Root, _extends2({}, rootProps, {
    children: [(0, import_jsx_runtime23.jsx)(Label, _extends2({}, labelProps, {
      children: props.label
    })), (0, import_jsx_runtime23.jsx)(List3, _extends2({}, listProps, {
...
function useOption(params) {
  ...
  return {
    getRootProps: (externalProps = {}) => {
      const externalEventHandlers = extractEventHandlers(externalProps);
      return _extends2({}, externalProps, getListItemProps(externalEventHandlers), {
        id,
        ref: handleRef,
        role: "option",
...
var Option = React43.memo(React43.forwardRef(function Option2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime25.jsx)(Root, _extends2({}, rootProps, {
    children: children2
  }));
}));
...
var Popup = React45.forwardRef(function Popup2(props, forwardedRef) {
  ...
  const rootProps = useSlotProps({
    ...
    additionalProps: {
      ref: handleRef,
      role: "tooltip",
      style: _extends2({}, floatingStyles, {
        display
      })
    }
  });
  ...
  return (0, import_jsx_runtime26.jsx)(Portal, {
    disablePortal,
    container,
    children: (0, import_jsx_runtime26.jsx)(Root, _extends2({}, rootProps, {
      children: typeof children2 === "function" ? children2(childProps) : children2
    }))
  });
});
...
function useSelect(props) {
  ...
  const getSelectTriggerProps = (otherHandlers = {}) => {
    return _extends2({}, otherHandlers, {
  ...
  const getButtonProps = (externalProps = {}) => {
    ...
    return _extends2({}, externalProps, combinedProps(externalEventHandlers));
  };
  const getListboxProps = (externalProps = {}) => {
    return _extends2({}, externalProps, {
      id: listboxId,
  ...
  const contextValue = React46.useMemo(() => _extends2({}, listContextValue, compoundComponentContextValue), [listContextValue, compoundComponentContextValue]);
  let selectValue;
  if (props.multiple) {
...
var Select = React48.forwardRef(function Select2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime29.jsxs)(React48.Fragment, {
    children: [(0, import_jsx_runtime28.jsx)(Button3, _extends2({}, buttonProps, {
    ...
    })), buttonDefined && (0, import_jsx_runtime28.jsx)(PopperComponent, _extends2({}, popperProps, {
      children: (0, import_jsx_runtime28.jsx)(ListboxRoot, _extends2({}, listboxProps, {
        children: (0, import_jsx_runtime28.jsx)(SelectProvider, {
          value: contextValue,
          children: children2
        })
      }))
    })), (0, import_jsx_runtime28.jsx)("input", _extends2({}, getHiddenInputProps()))]
  });
});
...
function useSlider(parameters) {
  ...
  const getHiddenInputProps = (externalProps = {}) => {
    ...
    return _extends2({
      ...
      style: _extends2({}, visuallyHidden_default, {
...
var Slider = React50.forwardRef(function Slider2(props, forwardedRef) {
  ...
  const partialOwnerState = _extends2({}, props, {
    marks: marksProp,
    disabled,
    disableSwap,
    isRtl,
  ...
  const {
    ...
    trackLeap,
    getThumbStyle
  } = useSlider(_extends2({}, partialOwnerState, {
    rootRef: forwardedRef
  }));
  const ownerState = _extends2({}, partialOwnerState, {
  ...
  return (0, import_jsx_runtime31.jsxs)(Root, _extends2({}, rootProps, {
    children: [(0, import_jsx_runtime30.jsx)(Rail, _extends2({}, railProps)), (0, import_jsx_runtime30.jsx)(Track, _extends2({}, trackProps)), marks.filter((mark) => mark.value >= min3 && mark.value <= max3).map((mark, index2) => {
      ...
      return (0, import_jsx_runtime31.jsxs)(React50.Fragment, {
        children: [(0, import_jsx_runtime30.jsx)(Mark, _extends2({
          "data-index": index2
        }, markProps, !isHostComponent(Mark) && {
          markActive
        }, {
          style: _extends2({}, style, markProps.style),
          className: clsx_default(markProps.className, markActive && classes.markActive)
        })), mark.label != null ? (0, import_jsx_runtime30.jsx)(MarkLabel, _extends2({
          "aria-hidden": true,
          "data-index": index2
        }, markLabelProps, !isHostComponent(MarkLabel) && {
          markLabelActive: markActive
        }, {
          style: _extends2({}, style, markLabelProps.style),
      ...
      return (0, import_jsx_runtime31.jsxs)(Thumb, _extends2({
        "data-index": index2
        ...
        style: _extends2({}, style, getThumbStyle(index2), thumbProps.style, resolvedSlotProps == null ? void 0 : resolvedSlotProps.style),
        children: [(0, import_jsx_runtime30.jsx)(Input5, _extends2({
          "data-index": index2,
        ...
        }, inputProps)), ValueLabel ? (0, import_jsx_runtime30.jsx)(ValueLabel, _extends2({}, !isHostComponent(ValueLabel) && {
          valueLabelFormat,
          index: index2,
          disabled
        }, valueLabelProps, {
...
var Snackbar = React52.forwardRef(function Snackbar2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime32.jsx)(ClickAwayListener, _extends2({}, clickAwayListenerProps, {
    children: (0, import_jsx_runtime32.jsx)(Root, _extends2({}, rootProps, {
      children: children2
    }))
  }));
});
...
function useSwitch(props) {
  ...
  const getInputProps = (otherProps = {}) => _extends2({
    checked: checkedProp,
    defaultChecked,
    disabled,
    readOnly,
...
var Switch = React54.forwardRef(function Switch2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime34.jsxs)(Root, _extends2({}, rootProps, {
    children: [(0, import_jsx_runtime33.jsx)(Track, _extends2({}, trackProps)), (0, import_jsx_runtime33.jsx)(Thumb, _extends2({}, thumbProps)), (0, import_jsx_runtime33.jsx)(Input5, _extends2({}, inputProps))]
  }));
});
...
var TablePaginationActions = React55.forwardRef(function TablePaginationActions2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime36.jsxs)(Root, _extends2({}, rootProps, {
    children: [showFirstButton && (0, import_jsx_runtime35.jsx)(FirstButton, _extends2({}, firstButtonProps, {
      children: direction === "rtl" ? (0, import_jsx_runtime35.jsx)(LastPageIcon, {}) : (0, import_jsx_runtime35.jsx)(FirstPageIcon, {})
    })), (0, import_jsx_runtime35.jsx)(BackButton, _extends2({}, backButtonProps, {
      children: direction === "rtl" ? (0, import_jsx_runtime35.jsx)(NextPageIcon, {}) : (0, import_jsx_runtime35.jsx)(BackPageIcon, {})
    })), (0, import_jsx_runtime35.jsx)(NextButton, _extends2({}, nextButtonProps, {
      children: direction === "rtl" ? (0, import_jsx_runtime35.jsx)(BackPageIcon, {}) : (0, import_jsx_runtime35.jsx)(NextPageIcon, {})
    })), showLastButton && (0, import_jsx_runtime35.jsx)(LastButton, _extends2({}, lastButtonProps, {
...
var TablePagination = React56.forwardRef(function TablePagination2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime37.jsx)(Root, _extends2({}, rootProps, {
    children: (0, import_jsx_runtime38.jsxs)(Toolbar, _extends2({}, toolbarProps, {
      children: [(0, import_jsx_runtime37.jsx)(Spacer, _extends2({}, spacerProps)), rowsPerPageOptions.length > 1 && (0, import_jsx_runtime37.jsx)(SelectLabel, _extends2({}, selectLabelProps, {
        children: labelRowsPerPage
      })), rowsPerPageOptions.length > 1 && (0, import_jsx_runtime37.jsx)(Select5, _extends2({}, selectProps, {
        children: rowsPerPageOptions.map((rowsPerPageOption) => (0, import_react2.createElement)(MenuItem3, _extends2({}, menuItemProps, {
          key: typeof rowsPerPageOption !== "number" && rowsPerPageOption.label ? rowsPerPageOption.label : rowsPerPageOption,
          value: typeof rowsPerPageOption !== "number" && rowsPerPageOption.value ? rowsPerPageOption.value : rowsPerPageOption
        }), typeof rowsPerPageOption !== "number" && rowsPerPageOption.label ? rowsPerPageOption.label : rowsPerPageOption))
      })), (0, import_jsx_runtime37.jsx)(DisplayedRows, _extends2({}, displayedRowsProps, {
      ...
      })), (0, import_jsx_runtime37.jsx)(Actions, _extends2({}, actionsProps))]
    }))
  }));
});
...
var Tabs = React60.forwardRef(function Tabs2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime40.jsx)(TabsRoot, _extends2({}, tabsRootProps, {
...
var TabPanel = React62.forwardRef(function TabPanel2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime41.jsx)(TabPanelRoot, _extends2({}, tabPanelRootProps, {
...
function useTabsList(parameters) {
  ...
  const getRootProps = (externalProps = {}) => {
    return _extends2({}, externalProps, getListboxRootProps(externalProps), {
      "aria-orientation": orientation === "vertical" ? "vertical" : void 0,
      role: "tablist"
    });
  };
  const contextValue = React63.useMemo(() => _extends2({}, compoundComponentContextValue, listContextValue), [compoundComponentContextValue, listContextValue]);
  return {
    contextValue,
    dispatch,
    getRootProps,
...
var TabsList = React65.forwardRef(function TabsList2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime43.jsx)(TabsListProvider, {
    value: contextValue,
    children: (0, import_jsx_runtime43.jsx)(TabsListRoot, _extends2({}, tabsListRootProps, {
      children: children2
    }))
  });
});
...
function useTab(parameters) {
  ...
  const getRootProps = (externalProps = {}) => {
    ...
    return _extends2({}, externalProps, getCombinedRootProps(externalEventHandlers), {
      role: "tab",
...
var Tab = React67.forwardRef(function Tab2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime44.jsx)(TabRoot, _extends2({}, tabRootProps, {
    children: children2
  }));
});
true ? Tab.propTypes = {
...
var TextareaAutosize = React68.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime46.jsxs)(React68.Fragment, {
    children: [(0, import_jsx_runtime45.jsx)("textarea", _extends2({
      value,
      onChange: handleChange,
      ref: handleRef,
      rows: minRows,
      ...
      ref: shadowRef,
      tabIndex: -1,
      style: _extends2({}, styles.shadow, style, {
        paddingTop: 0,
        paddingBottom: 0
      })
    })]
...
var FormControl3 = React80.forwardRef(function FormControl4(inProps, ref) {
  ...
  const [adornedStart, setAdornedStart] = React80.useState(() => {
    ...
    if (children2) {
      React80.Children.forEach(children2, (child) => {
...
var MenuList = React84.forwardRef(function MenuList2(props, ref) {
  ...
  React84.Children.forEach(children2, (child, index2) => {
  ...
  const items = React84.Children.map(children2, (child, index2) => {
...
var CSSTransition = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return import_react5.default.createElement(Transition_default, _extends3({}, props, {
  ...
  _proto.handleExited = function handleExited(child, node) {
    ...
    if (this.mounted) {
      this.setState(function(state) {
        var children2 = _extends3({}, state.children);
...
var ReplaceTransition = function(_React$Component) {
  ...
  _proto.render = function render() {
    var _this$props = this.props, children2 = _this$props.children, inProp = _this$props.in, props = _objectWithoutPropertiesLoose3(_this$props, ["children", "in"]);
...
var Fade = React92.forwardRef(function Fade2(props, ref) {
  const theme = useTheme();
  ...
  return (0, import_jsx_runtime63.jsx)(TransitionComponent, _extends({
    ...
    children: (state, childProps) => {
      return React92.cloneElement(children2, _extends({
        style: _extends({
          opacity: 0,
          visibility: state === "exited" && !inProp ? "hidden" : void 0
...
var Backdrop = React93.forwardRef(function Backdrop2(inProps, ref) {
...
var Paper = React95.forwardRef(function Paper2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPaper"
  });
...
var Popover = React96.forwardRef(function Popover2(inProps, ref) {
  ...
  const getAnchorOffset = React96.useCallback(() => {
  ...
  const getTransformOrigin = React96.useCallback((elemRect) => {
    return {
      vertical: getOffsetTop(elemRect, transformOrigin.vertical),
      horizontal: getOffsetLeft(elemRect, transformOrigin.horizontal)
    };
  }, [transformOrigin.horizontal, transformOrigin.vertical]);
  const getPositioningStyle = React96.useCallback((element) => {
    const elemRect = {
  ...
  const [isPositioned, setIsPositioned] = React96.useState(open);
  const setPositioningStyles = React96.useCallback(() => {
  ...
  React96.useImperativeHandle(action, () => open ? {
    updatePosition: () => {
      setPositioningStyles();
    }
...
var Menu3 = React97.forwardRef(function Menu4(inProps, ref) {
  ...
  const menuListActionsRef = React97.useRef(null);
  const handleEntering = (element, isAppearing) => {
  ...
  let activeItemIndex = -1;
  React97.Children.map(children2, (child, index2) => {
...
var NativeSelectInput = React98.forwardRef(function NativeSelectInput2(props, ref) {
  const {
    className,
    disabled,
    error,
  ...
  return (0, import_jsx_runtime71.jsxs)(React98.Fragment, {
...
var SelectInput = React99.forwardRef(function SelectInput2(props, ref) {
  ...
  const childrenArray = React99.Children.toArray(children2);
  const handleChange = (event) => {
  ...
  return (0, import_jsx_runtime73.jsxs)(React99.Fragment, {
...
var SvgIcon = React100.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  return (0, import_jsx_runtime75.jsxs)(SvgIconRoot, _extends({
    ...
    ownerState,
    children: [hasSvgAsChild ? children2.props.children : children2, titleAccess ? (0, import_jsx_runtime74.jsx)("title", {
...
var Select3 = React103.forwardRef(function Select4(inProps, ref) {
  const props = useThemeProps({
    name: "MuiSelect",
    props: inProps
  });
  ...
  return (0, import_jsx_runtime78.jsx)(React103.Fragment, {
